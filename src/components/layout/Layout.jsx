...
const ADMIN_NAV = [
  ...
  { label: 'Devoluciones Distrib.', icon: RotateCcw,  path: '/devoluciones-distribuidores', isAdmin: true },
  { label: 'Reporte Devoluciones', icon: BarChart2,   path: '/reporte-devoluciones',    isAdmin: true },
  ...
  { label: 'Pedidos Repuestos', icon: Wrench,   path: '/pedidos-repuestos',  isAdmin: true },
  ...
  { label: 'Producción', icon: Factory, isAdmin: true, submenu: 'produccion', children: [
    ...
    { label: 'Ingreso / Egreso',   icon: Clock,  path: '/produccion/asistencia' },
...
// Nav para chofer — solo Logística Diaria
const NAV_CHOFER = [
